...
public class ProductProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PRODUCT_ID:
                ...
                // For an example URI such as "content://com.example.android.invetoryapp/products/3",
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        // Check that the price is not null, check that it's greater than 0
        Integer price = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_PRICE);
        if (price == null || price < 0) {
            throw new IllegalArgumentException("Product price is required");
        }

        // Check that the quantity is not null and check that it's greater than 0
        ...
        // Notify all listeners that the data was changed for the product content URI
